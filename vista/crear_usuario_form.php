        ...
        <div class="row">
            <div class="col-md-3" style="height: 900px; background-color: #f8fafb">
                <div class="container">
                    ...
                    <div class="mt-5">
                        <img id="img2" class="rounded-circle mx-auto d-block responsive img-circle  clip-circle ml-5  float-center" style="width: 120px; height: 88px; margin-top:-30px; display:inline-block;"><br />
                    </div>
                ...
                <div class="encabezado container-fluid mt-5 ml-4 col-md-9 col-lg-9">
                    ...
                    <div class="ml-5">
                        <div class="ml-5">
                            ...
                            <div class="col-md-12 mt-5 ml-5">
                                <img id="img1" class="rounded-circle mx-auto d-block responsive img-circle  clip-circle  float-right ml-5" style="width: 120px; margin-top: -29px; height: 120px; display:inline-block;"><br />
                    ...
                    <div class="container-fluid mt-1">
                        ...
                        <div class=" float-left col-md-12 col-lg-12 col-sm-12">
                            ...
                            <form class="row g-3" id="editUser" action="crear_usuario_logic.php" method="POST" enctype="multipart/formdata">
                                ...
                                <?php } else { ?>
                                    <div class="ml-5">
                                        <h1 style="font-family: Champagne; margin-top: -80px; font-size:45px; " id="sesion" class="d-flex justify-content-lg-center ml-5  text-dark">Editar <?php echo $usuario->getNombres(); ?> 
                                        </h1>
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="txtContraseña" class="form-control" required placeholder="Contraseña" value="<?= $usuario->getContraseña() ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6  mt-2">
                                    ...
                                    <span class="btn btn-block btn-file">
                                        Subir imagen<input id="inputFile1" name="txtFoto" required value="<?= $usuario->getFoto() ?>" type="file">
                                    </span>
                                </div>
